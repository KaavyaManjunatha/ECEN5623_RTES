...
//U = 1.0
U32_T ex5_period[] = {3,5,15};
U32_T ex5_wcet[] = {1,2,4};
...
{ 
    ...
    printf("Ex-5 U=%4.2f (C1=1, C2=2, C3=4; T1=3, T2=5, T3=15; T=D): ",
		   ((1.0/2.0) + (2.0/5.0) + (4.0/15.0)));
    if(completion_time_feasibility(numServices, ex5_period, ex5_wcet, ex5_period) == TRUE)
        printf("FEASIBLE\n");
    else
        printf("INFEASIBLE\n");
    printf("Ex-6 U=%4.2f (C1=1, C2=2, C3=1; T1=2, T2=5, T3=10; T=D): ",
